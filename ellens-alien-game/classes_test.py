...
class ClassesTest(unittest.TestCase):
    ...
    def test_alien_has_health(self):
        alien = Alien(0, 0)
        error = "Expected object's health to be 3 but instead found " f"it had a health of {alien.health}."
    ...
    def test_alien_total_aliens_created(self):
        ...
        aliens = [Alien(-2, 6)]
        error = "Expected total_aliens_created to equal 1. Instead " f"it equals: {aliens[0].total_aliens_created}."
