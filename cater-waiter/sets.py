...
def check_drinks(drink_name: str, drink_ingredients: list[str]) -> str:
    ...
    """
    alcohols = set(drink_ingredients) & ALCOHOLS
    return f"{drink_name} {'Cocktail' if alcohols else 'Mocktail'}"
...
def categorize_dish(dish_name: str, dish_ingredients: list[str]) -> str:
    ...
    This function should return a string with the `dish name: <CATEGORY>` (which meal category
    the dish belongs to).
