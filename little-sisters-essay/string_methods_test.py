...
class LittleSistersEssayTest(unittest.TestCase):
    ...
    def test_capitalize_title(self):
        self.assertEqual(capitalize_title("fish are cold blooded"), "Fish Are Cold Blooded")
    ...
    def test_remove_extra_spaces(self):
        self.assertEqual(clean_up_spacing("  Elephants can't jump.  "), "Elephants can't jump.")
    ...
    @pytest.mark.task(taskno=4)
    def test_replace_full_word_only(self):
        self.assertEqual(
            replace_word_choice("The cat ate a mouse.", "a", "the"),
